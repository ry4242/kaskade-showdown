...
export const Abilities: {[abilityid: string]: AbilityData} = {
	...
	powerofalchemy: {
		onAllyFaint(target) {
			...
			const additionalBannedAbilities = [
				'noability', 'commander', 'evergreen', 'flowergift', 'forecast', 'hungerswitch', 'illusion', 'imposter', 'neutralizinggas', 'powerofalchemy', 'receiver', 'trace', 'wonderguard',
			];
	...
	trace: {
		...
		onUpdate(pokemon) {
			...
			const additionalBannedAbilities = [
				...
				'noability', 'commander', 'evergreen', 'flowergift', 'forecast', 'hungerswitch', 'illusion', 'imposter', 'neutralizinggas', 'powerofalchemy', 'receiver', 'trace', 'zenmode',
			];
	...
	wanderingspirit: {
		onDamagingHit(damage, target, source, move) {
			const additionalBannedAbilities = [
				'commander', 'evergreen', 'hungerswitch', 'illusion', 'neutralizinggas', 'wonderguard',
			];
