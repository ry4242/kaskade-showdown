export const Items: {[itemid: string]: ModdedItemData} = {
	...
	desertrose: {
		...
		onResidualSubOrder: 5,
		onResidual(pokemon) {
			if (pokemon.baseSpecies.num === 671 && this.field.isClimateWeather('sandstorm')) {
				this.heal(pokemon.baseMaxhp / 8);
			}
		},
		onModifySpDPriority: 1,
