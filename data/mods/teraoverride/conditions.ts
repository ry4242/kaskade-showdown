export const Conditions: import('../../../sim/dex-conditions').ModdedConditionDataTable = {
	...
	sandstorm: {
		...
		onModifySpD(spd, pokemon) {
			if (pokemon.hasType(this.effectState.source.teraType) && this.field.isIrritantWeather('sandstorm')) {
	...
	snowscape: {
		...
		onModifyDef(def, pokemon) {
			if (pokemon.hasType(this.effectState.source.teraType) && this.field.isClimateWeather('snowscape')) {
