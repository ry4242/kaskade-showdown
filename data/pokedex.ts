export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	klink: {
		...
		abilities: {0: "Light Metal", 1: "Minus", H: "Clear Body"},
		heightm: 0.3,
		weightkg: 21,
		color: "Gray",
		evos: ["Klang"],
	...
	klang: {
		...
		abilities: {0: "Heavy Metal", 1: "Minus", H: "Clear Body"},
		heightm: 0.6,
		weightkg: 51,
		color: "Gray",
		prevo: "Klink",
	...
	klinklang: {
		...
		abilities: {0: "Ferroflux", 1: "Minus", H: "Clear Body"},
		heightm: 0.6,
		weightkg: 81,
		color: "Gray",
		prevo: "Klang",
	...
	sizzlipede: { // updated
		...
		abilities: {0: "Flash Fire", 1: "White Smoke", H: "Flash Fire"},
		heightm: 0.7,
		weightkg: 1,
		color: "Red",
		evos: ["Centiskorch"],
