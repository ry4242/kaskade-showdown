...
describe('Primordial Sea', () => {
	...
	it('should activate the Primordial Sea climateWeather upon switch-in', () => {
	...
	it('should cause the Primordial Sea climateWeather to fade if it switches out and no other Primordial Sea Pokemon are active', () => {
		battle = common.createBattle();
	...
	it('should not cause the Primordial Sea climateWeather to fade if it switches out and another Primordial Sea Pokemon is active', () => {
		battle = common.createBattle();
		battle.setPlayer('p1', { team: [
			{ species: "Kyogre", ability: 'primordialsea', moves: ['helpinghand'] },
			{ species: "Ho-Oh", ability: 'pressure', moves: ['roost'] },
	...
	it('should not cause the Primordial Sea climateWeather to fade if its ability is suppressed and another Primordial Sea Pokemon is active', () => {
		battle = common.createBattle();
		battle.setPlayer('p1', { team: [{ species: "Kyogre", ability: 'primordialsea', moves: ['helpinghand'] }] });
