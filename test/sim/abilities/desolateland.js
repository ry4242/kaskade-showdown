...
describe('Desolate Land', () => {
	...
	it('should activate the Desolate Land climateWeather upon switch-in', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
		], [
			{ species: "Abra", ability: 'magicguard', moves: ['teleport'] },
		]]);
		assert(battle.field.isClimateWeather('desolateland'));
	});
	...
	it('should prevent moves and abilities from setting the climateWeather to Sunny Day, Rain Dance, Sandstorm, or Hail', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
		], [
			{ species: "Abra", ability: 'magicguard', moves: ['teleport'] },
	...
	it('should cause the Desolate Land climateWeather to fade if it switches out and no other Desolate Land Pokemon are active', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
		...
		assert.sets(() => battle.field.isClimateWeather('desolateland'), false, () => battle.makeChoices('switch 2', 'move roost'));
	});

	it('should not cause the Desolate Land climateWeather to fade if it switches out and another Desolate Land Pokemon is active', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
			{ species: "Ho-Oh", ability: 'pressure', moves: ['roost'] },
		], [
		...
		assert.constant(() => battle.field.isClimateWeather('desolateland'), () => battle.makeChoices('switch 2', 'move bulkup'));
	});

	it('should cause the Desolate Land climateWeather to fade if its ability is suppressed and no other Desolate Land Pokemon are active', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
		], [
			{ species: "Lugia", ability: 'pressure', moves: ['gastroacid'] },
		]]);
		assert.sets(() => battle.field.isClimateWeather('desolateland'), false, () => battle.makeChoices('move helpinghand', 'move gastroacid'));
	});

	it('should not cause the Desolate Land climateWeather to fade if its ability is suppressed and another Desolate Land Pokemon is active', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
		], [
			{ species: "Groudon", ability: 'desolateland', moves: ['gastroacid'] },
		]]);
		assert.constant(() => battle.field.isClimateWeather('desolateland'), () => battle.makeChoices('move helpinghand', 'move gastroacid'));
	});

	it('should cause the Desolate Land climateWeather to fade if its ability is changed and no other Desolate Land Pokemon are active', () => {
		battle = common.createBattle([[
			{ species: "Groudon", ability: 'desolateland', moves: ['helpinghand'] },
		], [
			{ species: "Lugia", ability: 'pressure', moves: ['entrainment'] },
		]]);
		assert.sets(() => battle.field.isClimateWeather('desolateland'), false, () => battle.makeChoices('move helpinghand', 'move entrainment'));
	});
	...
	it('should fade after being forced out via Roar', () => {
		...
		battle.makeChoices();
		assert.false(battle.field.isClimateWeather('desolateland'));
	});
