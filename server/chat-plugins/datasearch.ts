...
export const commands: Chat.ChatCommands = {
	...
	weathergy(target, room, user, connection, cmd, message) {
		...
		const weathergies: {
			...
			fog: {
				names: ["fog", "condensation", "foghorn"],
			...
			pollenstorm: {
				names: ["pollen storm", "hay fever", "pollinate"],
			...
			pheromones: {
				names: ["pheromones", "secretion", "swarm signal"],
			...
			smog: {
				names: ["smog", "pollution", "smog spread"],
			...
			fairydust: {
				names: ["fairy dust", "incantation", "sprinkle"],
			...
			battleaura: {
				names: ["battle aura", "stand off", "aura projection"],
			...
			paranormalactivity: {
				names: ["paranormal activity", "seance", "haunt"],
			...
			dreamscape: {
				names: ["dreamscape", "dreamer", "daydream"],
			...
			thunderstorm: {
				names: ["thunderstorm", "stormfront", "supercell"],
			...
			magnetosphere: {
				names: ["magnetosphere", "ferroflux", "magnetize"],
